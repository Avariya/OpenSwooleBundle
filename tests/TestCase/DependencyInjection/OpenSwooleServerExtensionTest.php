...
use OpenSwooleServerBundle\DependencyInjection\OpenSwooleServerExtension;
use OpenSwooleServerBundle\EventSubscriber\AMQPReconnectSubscriber;
...
final class OpenSwooleServerExtensionTest extends TestCase
{
        ...
        yield 'default' => [
            ...
            'expected' => [
                'services' => [
                    ...
                    'openswoole_server_bundle.server_task_messenger_handler',
                    'openswoole_server_bundle.server_task_noop_finish_handler',
                    'openswoole_server_bundle.server.symfony_request_factory',
                    'openswoole_server_bundle.server.psr_factory',
                ],
            ],
            'assertServices' => [
                Server::class => static function (Definition $definition) {
                    ...
                    self::assertReferenceIs('openswoole_server_bundle.server.symfony_request_factory', $definition->getArgument(7));
                    self::assertReferenceIs('openswoole_server_bundle.server.psr_factory', $definition->getArgument(8));
    ...
    {
        $extension = new OpenSwooleServerExtension();
